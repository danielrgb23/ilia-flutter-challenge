...
class DataPopularMoviesEntityModel extends MovieEntity implements Model {
  DataPopularMoviesEntityModel(
    final bool adult,
  ...
  @override
  factory DataPopularMoviesEntityModel.fromJson(Map<String, dynamic> json) {
    return DataPopularMoviesEntityModel(
      json["adult"] ?? false,
      json["backdrop_path"] ?? '',
      json["genre_ids"] ?? [],
      json["id"] ?? 0,
  ...
  factory DataPopularMoviesEntityModel.copy(MovieEntity movieEntity) {
    return DataPopularMoviesEntityModel(
        movieEntity.adult,
